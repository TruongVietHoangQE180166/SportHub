  ...
  useEffect(() => {
    ...
    const themeColors: ThemeColors =
      theme === "dark"
        ? {
            background: "#000000",
            meteorHead: "rgba(0, 255, 0, 1)", // Bright green
            meteorTailStart: "rgba(0, 255, 0, 1)", // Bright green
            meteorTailMiddle: "rgba(0, 200, 0, 0.8)", // Slightly darker green
            meteorTailEnd: "rgba(0, 150, 0, 0.1)" // Dark green with low opacity
          }
        : {
            background: "#ffffff", // White background
            meteorHead: "rgba(0, 200, 0, 1)", // Green head
            meteorTailStart: "rgba(0, 200, 0, 1)", // Green start
            meteorTailMiddle: "rgba(0, 150, 0, 0.8)", // Darker green middle
            meteorTailEnd: "rgba(0, 100, 0, 0.1)" // Even darker green end
          };
